...
* Add a "`<your github username>.md`" file to the [fellows folder in the website repository](https://github.com/uscms-software-and-computing/uscms-software-and-computing.github.io/tree/master/pages/fellows). Here is an example:
...
title: <Your Name> - USCMS S&C Fellow
active: True
dates:
  start: <start date>
  end: <end date>
