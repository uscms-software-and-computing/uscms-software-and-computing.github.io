...
presentations:
  - title: "SONIC for CMS Phase 2"
    date: "June 4, 2026"
    url: https://indico.cern.ch/event/1669067/contributions/7021913/attachments/3287943/5878136/SONIC_ML_reconstruction_20260526_v2.pdf
    meeting: ML for reconstruction workshop
    meetingurl: https://indico.cern.ch/event/1669067/
  - title: "Introduction to computing resources, Purdue analysis facility and NRP"
    date: "February 23, 2026"
    url: https://indico.cern.ch/event/1643166/contributions/6948257/attachments/3225300/5747918/Computing%20Resources%20Demo.pdf
    meeting: ML Inference for CMS Data Production Hackathon at the LPC
    meetingurl: https://indico.cern.ch/event/1643166/
  - title: "Inference as a service and SONIC"
    date: "February 23, 2026"
    url: https://indico.cern.ch/event/1643166/contributions/6948253/attachments/3225262/5748272/IaaS_at_CMS_and%20SONIC.pdf
    meeting: ML Inference for CMS Data Production Hackathon at the LPC
    meetingurl: https://indico.cern.ch/event/1643166/
  - title: "SONIC at CMS"
...
current_status: >
    ...
    *   Progress
        *   Delivered a complete workflow in which a CMS job sends inputs to a Triton server, runs LST algorithm and receives output. The backend is now able to load the LST algorithm on CPU or GPU through a simple change in the config.pbtxt setup. The CMSSW client can use a process modifier to enable SONIC, and the original local workflow still works if there is no SONIC process modifier in the cmsConfig file.
        *   Validated input/output being delivered to/from a Triton server that loads the LST Alpaka algorithm.
        *   Performance benchmarking of the LST Alpaka algorithm on a Triton server at the Purdue Hammer cluster.
        *   Documentation: LST Alpaka backend compilation and model setup, and the LST SONIC workflow in CMSSW, are documented, and the code is pushed to GitHub.
    ...
    *   Progress
        *   Organized the 1-week ML Inference for CMS Data Production Hackathon at the LPC on Feb 23–27. Preparation work included proposing projects, contacting experts, and connecting participants with experts. Also prepared GPU resources for participants on the National Research Platform (NRP) with Dr. Daniel Diaz and Dr. Dmitry Kondratyev, including setting up single Triton servers, as well as deploying SuperSONIC on NRP and sending client jobs from the Purdue AF. During the workshop, gave an introduction talk on SONIC and a tutorial about it.
        *   The workshop helped kick off multiple developments, including SONIC-related activities: 1) Connecting with the KIT team for deploying SuperSONIC at their Tier2 site; 2) Deploying SuperSONIC for analysis purposes.
